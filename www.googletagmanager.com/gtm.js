...
(function() {
    ...
    */
    ...
    Bd.xd = "6t0";
    Bd.aa = "dataLayer";
    Bd.gh = "ChAI8IialgYQncrRjtTR8e8EEiQAhkpOyN+SAz2utisdiE4x/BfUbhH1w1NrMusqULRmocpD8dAaAp6C";
    var Dd = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var Wp = {
            config: function(a, b) {
                ...
                var n = Vp() || Qo;
                b.noTargetGroup || (qp && f ? (pp(e.id), mp(e.id, d[T.g.gd] || "default")) : (op(e.id), kp(e.id, d[T.g.gd] || "default")));
                delete d[T.g.gd];
                Sp || Q(43);
                if (n) {
                    var p = [e.id];
            ...
            event: function(a, b) {
                ...
                if (!(2 > a.length) && m(c)) {
                    ...
                    var q = d,
                        r = q && q[T.g.ob];
                    void 0 === r && (r = Vd(T.g.ob, 2), void 0 === r && (r = "default"));
                    if (m(r) || ra(r)) {
    ...
    Z.m.f = ["google"],
        function() {
            (function(a) {
                ...
                var b = sr("gtm.referrer", 1) || H.referrer;
                return b ? a.vtp_component && "URL" != a.vtp_component ? pe(re(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey) : rr(String(b)) : String(b)
            })
        }();

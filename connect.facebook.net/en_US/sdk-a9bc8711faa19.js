/*1657252876,,JIT Construction: v1005809633,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("LiveChatPluginConstants", ["$InternalEnum"], (function(a, b, c, d, e, f) {
                    ...
                    var p = "platform/plugins/connect/access_token",
                        q = 124,
                        r = 187,
                        s = 24,
                        t = 424,
                        ...
                        M = 8634e4,
                        N = "#8A8D91",
                        O = "entrypoint:customer_chat_plugin",
                        P = 0,
                        Q = 1,
                        R = 2,
                        S = 3,
                        T = "new_message_update",
                        U = "initial_fetch",
                        V = 5e3,
                        W = "https://www.facebook.com/business/help/1661027437357021";
                    f.MQTT = c;
                    ...
                    f.ACCESS_TOKEN_LOGIN = p;
                    f.PROMPT_FALLBACK_HEIGHT = q;
                    f.PROMPT_REDESIGN_FALLBACK_HEIGHT = r;
                    f.PROMPT_CONTAINER_PADDING_HEIGHT = s;
                    f.WELCOME_PAGE_GUEST_FALLBACK_HEIGHT = t;
                    f.WELCOME_PAGE_NO_GUEST_FALLBACK_HEIGHT = u;
                    f.WELCOME_PAGE_GUEST_FALLBACK_HEIGHT_WITH_COMPACT = v;
                    f.WELCOME_PAGE_NO_GUEST_FALLBACK_HEIGHT_WITH_COMPACT = w;
                    f.WELCOME_PAGE_ATTRIBUTION_OFFEST_HEIGHT = x;
                    f.WELCOME_PAGE_ATTRIBUTION_OFFSET_HEIGHT_WITH_COMPACT = y;
                    f.MAIN_IFRAME_PADDING_HEIGHT = z;
                    f.MAIN_IFRAME_PADDING_HEIGHT_WITH_COMPACT = A;
                    f.THREAD_PAGE_HEIGHT = B;
                    f.THREAD_PAGE_HEIGHT_COMPACT = C;
                    f.RE_ENGAGEMENT_COLLAPSED_DIALOG_HEIGHT = D;
                    f.RE_ENGAGEMENT_COLLAPSED_DIALOG_HEIGHT_COMPACT = E;
                    f.RE_ENGAGEMENT_EXPANDED_DIALOG_HEIGHT = F;
                    f.RE_ENGAGEMENT_EXPANDED_DIALOG_HEIGHT_COMPACT = G;
                    f.GREETING_TEXT_BOTTOM_SPACING_OFFEST = H;
                    f.LOGGED_IN_CHAT_MODE = I;
                    f.GUEST_CHAT_MODE = J;
                    f.INVALID_CHAT_MODE = K;
                    f.MESSENGING_PLUGIN = L;
                    f.GUEST_SESSION_STORAGE_VALIDITY_MS = M;
                    f.GUEST_SEND_BUTTON_COLOR_EMPTY_INPUT = N;
                    f.LIVE_CHAT_ENTRYPOINT_ATTRIBUTION_TAG = O;
                    f.ITP_CONSISTENCY_UNKNOWN_LOGGED_OUT = P;
                    f.ITP_CONSISTENCY_CONSISTENT_LOGGED_IN = Q;
                    f.ITP_CONSISTENCY_INCONSISTENT = R;
                    f.ITP_CONSISTENCY_CONSISTENT_NO_ITP = S;
                    f.NEW_MESSAGE_UPDATE = T;
                    f.INITIAL_FETCH = U;
                    f.PLUGIN_FADE_DELAY = V;
                    f.HELP_DEX_LINK = W
                }), 66);
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1005809633","namespace":"FB","message":"' + e.message + '"}}');

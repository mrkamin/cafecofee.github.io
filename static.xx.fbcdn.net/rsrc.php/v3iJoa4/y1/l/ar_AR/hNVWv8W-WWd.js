...
(function(a) {
    ...
    function Q() {
        ...
        M || S.apply(null, [
            ["FBLogger"],
            function(a) {
                a("binary_transparency", "invalid_vmod_use").mustfix("_checkFbtVirtualModuleTimeout timeout queued when _useFbtVirtualModules is false!")
            }
        ]);
        var a = z(),
            b = Object.keys(N),
        ...
        c.length > 0 && S.apply(null, [
            ["FBLogger"],
            function(a) {
                a("binary_transparency", "vmod_timeout").warn("The following virtual modules are taking over %s ms to be defined: %s...", P, c.join(",").slice(0, 300))
            }
        ])
    }
    ...
    var JSON_HIJACKING_SHIELD = "for (;;);",
        ...
        AsyncRequest = function() {
            ...
            _proto._invokeErrorHandler = function _invokeErrorHandler(explicitError) {
                ...
                if (error === NO_NETWORK_CONNECTION) summary = fbt._( /*FBT_CALL*/ "\u0644\u0627 \u0627\u062a\u0635\u0627\u0644 \u0628\u0627\u0644\u0634\u0628\u0643\u0629" /*FBT_CALL*/ ), desc = fbt._( /*FBT_CALL*/ "\u064a\u0628\u062f\u0648 \u0623\u0646 \u0627\u0644\u0645\u062a\u0635\u0641\u062d \u0644\u062f\u064a\u0643 \u063a\u064a\u0631 \u0645\u062a\u0635\u0644. \u064a\u0631\u062c\u0649 \u0627\u0644\u062a\u062d\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062a\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062a\u0631\u0646\u062a \u0648\u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629." /*FBT_CALL*/ );
                else if (error >= 300 && error <= 399) {
                    summary = fbt._( /*FBT_CALL*/ "\u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u062a\u0648\u062c\u064a\u0647" /*FBT_CALL*/ );
                    desc = fbt._( /*FBT_CALL*/ "\u062a\u0645\u062a \u0625\u0639\u0627\u062f\u0629 \u062a\u0648\u062c\u064a\u0647 \u0648\u0635\u0648\u0644\u0643 \u0625\u0644\u0649 \u0641\u064a\u0633 \u0628\u0648\u0643 \u0623\u0648 \u062d\u0638\u0631\u0647 \u0645\u0646 \u0642\u0628\u0644 \u0637\u0631\u0641 \u062b\u0627\u0644\u062b \u0641\u064a \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062a\u060c \u064a\u0631\u062c\u0649 \u0627\u0644\u0627\u062a\u0635\u0627\u0644 \u0628\u0645\u0648\u0641\u0631 \u062e\u062f\u0645\u0629 \u0625\u0646\u062a\u0631\u0646\u062a \u0623\u0648 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u062a\u062d\u0645\u064a\u0644." /*FBT_CALL*/ );
                    var location = transport.getResponseHeader("Location");
                    location && importDefault("goURI")(location, !0);
                    silent = !0
                } else summary = fbt._( /*FBT_CALL*/ "\u0639\u0630\u0631\u0627\u064b" /*FBT_CALL*/ ), desc = fbt._( /*FBT_CALL*/ "\u062d\u062f\u062b \u062e\u0637\u0623\u060c \u0648\u0646\u0639\u0645\u0644 \u0639\u0644\u0649 \u0625\u0635\u0644\u0627\u062d\u0647 \u0641\u064a \u0623\u0642\u0631\u0628 \u0648\u0642\u062a \u0645\u0645\u0643\u0646. \u064a\u0645\u0643\u0646\u0643 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629 \u0628\u0639\u062f \u0642\u0644\u064a\u0644." /*FBT_CALL*/ );
